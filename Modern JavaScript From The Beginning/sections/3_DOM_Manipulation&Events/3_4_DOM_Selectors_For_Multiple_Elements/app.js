...
// * which mean that each collection-item that we will meed in the scan of the DOM,
...
// * NodeList take in account not just elements, also text nodes and we can do with NodeList action that we can do with array
