...
// * we have to add the listener onto a parent (in this case the all div that wraps the game) and then to search for the target that we want which it "play-again"
